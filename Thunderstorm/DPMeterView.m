...
//    [self setShape:shape];
    ...
    maskLayer.contents = (__bridge id) [[UIImage imageNamed:@"twitter.png"] CGImage];
    [maskLayer setBounds:CGRectMake(0, 0, 140, 114)];
    [maskLayer setFrame:CGRectMake(0, 0, 140, 114)];
